...
| 파일 | 변주 | 코어다움 | 메모 |
|---|---|---|---|
| decoden-attach-01.png | 재질 교체 | ⬜ | |
| decoden-attach-02.png | 볼륨 업 | ⬜ | |
| decoden-attach-03.png | 클러스터 밀집 | ⬜ | |
...
- Palette: Stark White (#ffffff, 40% of the surface — the ground colour every tip starts from); Baby Pink (#ecaec0, 30% of the surface — a colour the design is drawn in); Obsidian Black (#111111, 15% of the surface — a colour the design is drawn in); Silver Chrome (#b1b3b6, 15% of the surface — a small-quantity accent for lines, dots, and metal).
- Motifs to use, each keeping exactly the material named here: 3D sculpted orchid rendered as sculpted at big scale, 3mm or more; chunky pearls rendered as pearl at standard scale; metal piercing rings rendered as metal at big scale, 3mm or more; gothic script lettering rendered as painted at standard scale.
...
- Mood: A bold and maximalist blend of girly romance and edgy Y2K street style.
